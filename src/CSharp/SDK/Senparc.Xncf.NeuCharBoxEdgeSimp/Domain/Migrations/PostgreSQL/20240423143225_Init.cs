...
namespace Senparc.Xncf.NeuCharBoxEdgeSimp.Domain.Migrations.PostgreSQL
{
    /// <inheritdoc />
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "Senparc_NeuCharBoxEdgeSimp_Color",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Senparc_NeuCharBoxEdgeSimp_Color", x => x.Id);
                });
        }
